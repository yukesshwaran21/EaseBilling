      ...
      <div className="admin-login-container">
        ...
        >
          <div className="admin-login-header">
            ...
            <p className="admin-login-description">Enter your credentials to access the admin dashboard</p>
          </div>
          <div className="admin-login-content">
            <form onSubmit={handleLogin} className="admin-login-form">
              ...
              {loginError && (
                <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="admin-login-error">
                  {loginError}
                </motion.div>
              )}
  ...
  return (
    <div className="admin-dashboard-container">
      ...
      <div className="admin-mobile-menu-button">
        <button onClick={() => setIsMobileMenuOpen(true)} className="admin-icon-button">
      ...
      {/* Mobile Sidebar */}
      {isMobileMenuOpen && (
        <div className="admin-mobile-sidebar-overlay" onClick={() => setIsMobileMenuOpen(false)}>
          <div className="admin-mobile-sidebar" onClick={(e) => e.stopPropagation()}>
            <div className="admin-mobile-sidebar-header">
              ...
              <button className="admin-mobile-sidebar-close" onClick={() => setIsMobileMenuOpen(false)}>
              ...
              >
                ...
                <div className="admin-card">
                  ...
                  <div className="admin-card-footer">
                    <button onClick={addMedicine} className="admin-button admin-button-primary" disabled={isLoading}>
                      {isLoading ? (
                        <span className="admin-button-content">
            ...
            {activeTab === "manageWorkers" && (
              ...
              >
                ...
                <div className="admin-card">
                  ...
                  <div className="admin-card-footer">
                    <button onClick={addWorker} className="admin-button admin-button-primary" disabled={isLoading}>
                      {isLoading ? (
                        <span className="admin-button-content">
                          <Loader2 className="admin-button-icon spin" /> Adding...
                        </span>
                ...
                <div className="admin-card">
                  ...
                  <div className="admin-card-content">
                    <table className="admin-data-table">
                      ...
                      <tbody>
                        {workers.map((worker) => (
                          <tr key={worker._id} className="admin-table-row">
              ...
              >
                ...
                <div className="admin-stats-grid">
                  <div className="admin-stat-card admin-stat-card-green">
                    ...
                    <div className="admin-stat-card-content">
                      <div className="admin-stat-card-info">
                        <p className="admin-stat-card-value">₹{totalSales.toFixed(2)}</p>
                  ...
                  <div className="admin-stat-card admin-stat-card-blue">
                    ...
                    <div className="admin-stat-card-content">
                      <div className="admin-stat-card-info">
                        <p className="admin-stat-card-value">₹{totalGST.toFixed(2)}</p>
                  ...
                  <table className="admin-data-table">
                    ...
                    <tbody>
                      {invoices
                        ...
                        .map((inv) => (
                          <tr key={inv._id} className="admin-table-row">
                            ...
                            <td>
                              <button className="admin-button admin-button-small" onClick={() => setSelectedTransaction(inv)}>
                                View Details
                              </button>
                            </td>
                          </tr>
                  ...
                  <div className="admin-modal-overlay" onClick={() => setSelectedTransaction(null)}>
                    <div className="admin-modal" onClick={(e) => e.stopPropagation()}>
                      <div className="admin-modal-header">
                        ...
                        <button className="admin-modal-close" onClick={() => setSelectedTransaction(null)}>
                          <X className="admin-icon" />
                        </button>
                      </div>
              ...
              >
                ...
                <div className="admin-card">
                  <table className="admin-data-table">
                    ...
                    <tbody>
                      {requests.map((req) => (
                        <tr key={req._id} className="admin-table-row">
